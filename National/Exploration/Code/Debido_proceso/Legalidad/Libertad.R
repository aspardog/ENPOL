...
Descripción de gráfico: La proporción de la población en prisión preventiva aumentó, conforme ha madurado el sistema penal. 

3.2.8. Trato diferenciado en la prisión preventiva (Logit)
Descripción de gráfico: Las personas xxxx tienen mayor probabilidad de estar en prisión preventiva. 
COMENTARIO PRUEBA DE ROBUSTEZ: Verificar; controlar por delito y estado

3.2.9. Cambios en la severidad de las sentencias (Línea de tiempo)
Descripción de gráfico: La proporción de la severidad de las sentencias aumentó, conforme ha madurado el sistema penal. 

3.2.10. Trato diferenciado en la severidad de la sentencia (Logit)
Descripción de gráfico: Las personas xxxx tienen mayor probabilidad de recibir una sentencia más severa que otras personas.
