...
setData.fn <- function(data, group_col, legal_col) {
...
MulipleBar.fn <- function () { plot <- ggplot(data2plot,
               aes(
                 x     = labels, 
                 y     = Percentage,
                 fill  = group,
...
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
##
## 13.  Bar Chart by groups                                                                                ----
##
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

barsChartN.fn <- function(
    data.df                    = data2plot,
    labels_var                 = "labels",
    value2plot                 = "value2plot",
    groupVar                   = T,
  ...
  if(groupVar == F){
    ...
    plot <- ggplot(data2plot,
                   aes(
                     ...
                     y     = value2plot,
                     fill  = labels,
                     label = paste0(label_figures, ", N =", Frequency)
                   )) +
      geom_bar(stat = "identity",
               show.legend = F,
               position = position_dodge(widt = 0.9)) +
